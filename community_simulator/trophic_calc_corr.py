...
#folder = '/Users/robertmarsland/Dropbox (Personal)/BU/Trophic Cavity Calc/vary_sigc_new'
...
for item in old[0].index:
    ...
    if params['K']>=0.7:
        ...
        for q in range(4):
            old[q].loc[item]=out[q].loc[item].values
